...
import LanguageReason from '../lib/language-reason';
  ...
  describe('when the language-reason:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      runs(() => {
        ...
        let languageReasonElement = workspaceElement.querySelector('.language-reason');
        expect(languageReasonElement).toExist();

        let languageReasonPanel = atom.workspace.panelForItem(languageReasonElement);
